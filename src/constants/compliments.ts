export const compliments = [
  ...
  'Funny compliment about girls and pizza',
  ...
  'Funny compliment about being embarrassed!',
...
export const randomCompliment = () => {
  const numOfCompliments = compliments.length;
  const complimentIndex = Math.floor(Math.random() * numOfCompliments);
